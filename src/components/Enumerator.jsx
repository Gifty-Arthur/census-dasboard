...
const Enumerator = () => {
  ...
  // Fetch records with abort controller
  const fetchRecords = () => {
  ...
  React.useEffect(() => {
    // Create new abort controller on mount
  ...
  // CRUD operations with abort control
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Enumerator Management</h1>
          <button
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {records.map((record) => (
                  <tr key={record.enumeratorid} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 text-sm text-gray-600 font-medium">{record.enumeratorid}</td>
              ...
              <form onSubmit={newRecordFormVisible ? handleNewRecordSubmit : handleUpdateRecordSubmit} className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold">
                    {newRecordFormVisible ? 'Add New Enumerator' : 'Update Enumerator'}
                  </h3>
                  <button
                    type="button"
                    onClick={() => {
                ...
                <div className="mt-6 flex gap-3 justify-end">
                  ...
                  >
                    {newRecordFormVisible ? 'Create Enumerator' : 'Save Changes'}
                  </button>
                </div>
              </form>
            </div>
        ...
        {viewRecordModalVisible && viewRecord && (
          <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl w-full max-w-md animate-slide-up">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold">Enumerator Details</h3>
                  <button
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-gray-900">{viewRecord.enumeratorid}</p>
                  </div>
                  <div>
